...
1. No. Since the loss function of generator score is based on how many images generated by him was labeled as fake 
   ...
   loss will be very good regardless the images it generates, i.e. generator loss is depended
   on the discriminator ability to recognize fake images.
...
Using gan our result were sharper and VAE are more realistic.
Using Vae we got ...
