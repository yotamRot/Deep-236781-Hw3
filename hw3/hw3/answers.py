...
part3_q3 = r"""
**Your answer:**
In output images main difference between Gan and Vae is that Vae produced smoother images.
Reason for it loss function is more simple and trained on real images that are smooth. Therfore generataed images 
...
can represent much more complex models/functions and therfore it can create much comlex images
